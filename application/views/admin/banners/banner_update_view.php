<?php $this->load->view('admin/templates/header', array(
	...
	'breadcrumbs' => array(
		...
		1 => array('name'=> isset($banner->title) ? $banner->title : 'Update a banner', 'link'=>FALSE)
	)
)); ?>

<div class="lead page-header b-0">Update Banner</div>
...
<?php echo form_open_multipart(current_url()) ?>
				...
				<div class="panel-body">
					...
					<div class="tab-content" style="margin-top:20px">
						...
						<div role="tabpanel" class="tab-pane" id="profile">
							...
							<textarea class="form-control" name="html_text" rows="8"><?php echo set_value('html_text') ? set_value('html_text') : $banner->html ?></textarea>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="form-group">
		<input type="submit" class="btn btn-success" name="update_banner" value="Update Banner" />
    </div>
<?php echo form_close() ?>
