...
*/
	...
	*/
	...
	$config['database']['configuration']['columns']['pagination_limit'] = 'config_pagination_limit';
	$config['database']['configuration']['columns']['user_file_limit'] = 'config_user_files_limit';
