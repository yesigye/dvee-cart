...
class Category_model extends CI_Model
{
	...
	public function add_category()
	{
		...
		if ($is_category_added)
		{
			...
			$this->flexi_cart_admin->set_status_message('Category "'.$this->input->post('name').'" has been added.', 'admin', TRUE);
		...
		else
		{
			...
			$this->flexi_cart_admin->set_error_message('Category could not be added.', 'admin', TRUE);
